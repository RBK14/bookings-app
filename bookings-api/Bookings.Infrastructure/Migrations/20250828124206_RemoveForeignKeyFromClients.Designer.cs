...
namespace Bookings.Infrastructure.Migrations
{
    ...
    [Migration("20250828124206_RemoveForeignKeyFromClients")]
    partial class RemoveForeignKeyFromClients
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Bookings.Domain.UserAggregate.User", b =>
                {
                    ...
                    b.OwnsOne("Bookings.Domain.UserAggregate.ValueObjects.Email", "Email", b1 =>
                        {
                            b1.Property<Guid>("UserId")
                                .HasColumnType("uniqueidentifier");
